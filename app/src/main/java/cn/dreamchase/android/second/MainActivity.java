...
import cn.dreamchase.android.second.activity.AcceptChuanZhiHuiChuanZhiActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.chuan_zhi).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, AcceptChuanZhiHuiChuanZhiActivity.class);
