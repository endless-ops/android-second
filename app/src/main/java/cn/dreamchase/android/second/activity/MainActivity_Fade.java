...
public class MainActivity_Fade extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActivity_Fade.this, FadeActivity.class);
                ...
                startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(MainActivity_Fade.this).toBundle());
