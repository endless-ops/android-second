...
public class MainActivity_Exploder extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActivity_Exploder.this, ExplodeActivity.class);
                ...
                startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(MainActivity_Exploder.this).toBundle());
